...
(function() {
    ...
    Coach.prototype.respond = function(str, sel) {
        ...
        const strData = functions.getStrData(this.info.sessions,
                this.info.iteration, this.info.depth, str, cleanStr, sel, tokens,
                this.info.lastCategory, this.info.lastQuestion,
                this.info.lastResponse, this.options.translate);
        ...
        const qReply = functions.getQuestion(cleanStr, strData, sel,
                this.info.depthTopic, this.info.lastQuestion, this.options);
